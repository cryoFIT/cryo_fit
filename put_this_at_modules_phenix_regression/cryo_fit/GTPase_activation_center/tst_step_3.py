...
def run(prefix="tst_step_3"):
  """
  Exercise phenix.cryo_fit step_3 with all defaults with "few_RNAs.pdb"
  """
  ...
  the_step_was_successfully_ran = check_whether_the_step_was_successfully_ran("Step 3", "to_minimize.tpr")  
