...
def run(prefix="tst_step_6"):
    """
    Exercise phenix.cryo_fit step_6 with all defaults with "few_RNAs.pdb"
    """
    ...
    for check_this_file in glob.glob("*_0_charge.top"): # there will be only one file like this
      the_step_was_successfully_ran = check_whether_the_step_was_successfully_ran("Step 6", check_this_file)
