...
if (__name__ == "__main__") :
    ...
    regression_path_1 = os.path.join(cryo_fit_repository_dir,
                                     'regression',
                                     'emd_8249')
    ...
    regression_path_2 = os.path.join(cryo_fit_repository_dir,
                                     'regression',
    ...
    regression_path_3 = os.path.join(cryo_fit_repository_dir,
                                     'regression',
                                     'Adenylate_Kinase')
    ...
    regression_path_4 = os.path.join(cryo_fit_repository_dir,
                                     'regression',
                                     'emd_8249_restart')
